...
const electricityBreakupSchema = new mongoose.Schema({
    ...
    fixLoadcharges: { type: Number, default: 0 },
    load: { type: Number, default: 0 },
    fixmantance: { type: Number, default: 0 },
    dgTariff: { type: Number, default: 0 },
    surchargePercent: { type: Number, default: 0 },
    fixLoadchargesAmount: { type: Number, default: 0 },
    fixmantanceAmount: { type: Number, default: 0 },
